...
var ROUTES = [
    ...
    { path: '/management-barang', title: 'Managemen Barang', icon: 'education_atom', class: '' },
    { path: '/maps', title: 'POS Service', icon: 'location_map-big', class: '' }
